...
// 	models.Shipper.findOne({ where: { email: email } }).then((response) => {
// 		if (response) {
// 			return res.status(409).json({
// 				message: 'Email already existed. Please use another one'
// 			})
// 		}
...
// 				models.Shipper.create(user).then((result) => {
// 					res
// 						.status(201)
// 						.json({
...
// 	models.Shipper.findOne({ where: { email: email } })
// 		.then((user) => {
// 			if (!user) {
